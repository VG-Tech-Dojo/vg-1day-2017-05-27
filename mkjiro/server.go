...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/mkjiro/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/mkjiro/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/mkjiro/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/mkjiro/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/mkjiro", func(c *gin.Context) {
		c.HTML(http.StatusOK, "mkjiro.html", gin.H{})
	})
