...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/kitamura/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/kitamura/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/kitamura/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/kitamura/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/kitamura", func(c *gin.Context) {
