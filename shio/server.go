...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/shio/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/shio/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/shio/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/shio/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/shio", func(c *gin.Context) {
