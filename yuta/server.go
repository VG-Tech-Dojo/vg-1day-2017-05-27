...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yuta/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yuta/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yuta/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yuta/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	// ...
	s.Engine.GET("/yuta", func(c *gin.Context) {
		c.HTML(http.StatusOK, "yuta.html", gin.H{})
	})
