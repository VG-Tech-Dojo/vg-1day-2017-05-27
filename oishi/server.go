...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/oishi/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/oishi/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/oishi/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/oishi", func(c *gin.Context) {
		c.HTML(http.StatusOK, "oishi.html", gin.H{})
	})
