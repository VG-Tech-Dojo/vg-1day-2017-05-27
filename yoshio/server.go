...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yoshio/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yoshio/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yoshio/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yoshio/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	// ...
	s.Engine.GET("/yoshio", func(c *gin.Context) {
		c.HTML(http.StatusOK, "yoshio.html", gin.H{})
	})
