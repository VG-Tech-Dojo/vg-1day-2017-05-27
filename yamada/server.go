...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yamada/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yamada/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/yamada/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/yamada", func(c *gin.Context) {
		c.HTML(http.StatusOK, "yamada.html", gin.H{})
	})
