...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/toshi/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/toshi/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/toshi/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/toshi", func(c *gin.Context) {
		c.HTML(http.StatusOK, "about_toshi.html", gin.H{})
	})
