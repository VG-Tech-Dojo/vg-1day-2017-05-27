...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/teshiba/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/teshiba/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-27/teshiba/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	talkBot := bot.NewGachaBot(s.poster.In)
	return nil
}
